...
public class CalendarPanel extends JPanel {
	...
	private Color[] monthHeader = {Color.red,Color.blue,Color.green,Color.BLACK,Color.lightGray
			,Color.cyan,Color.magenta,Color.DARK_GRAY,Color.WHITE,Color.orange,Color.pink,Color.yellow};
	...
	public CalendarPanel (int month, int border, GregorianCalendar gCalendar) {
		...
		headingPanel.setBackground(monthHeader[month]);
